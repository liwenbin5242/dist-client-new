...
<script>
  ...
  export default {
    ...
    data() {
      return {
        imageUrl: process.env.VUE_APP_BASE_API + '/view/thumbnail?disk-token=' + this.$store.state.user.token + '&id=',
        audioCoverUrl: process.env.VUE_APP_BASE_API + '/view/cover?disk-token=' + this.$store.state.user.token + '&id=',
        fileMenuActive: '',
